...
list.of.packages <- c("tidyverse", "haven", "here", "ggvis", "kableExtra", 'bookdown',
                      "rootSolve","shinyBS", "shinythemes","ggplot2")
...
## `r paste0(main_tax_po * 100, "%")` tax on all wealth above `r paste0("$",starting_brack_po/1e6)` millions
...
## `r paste0((max_tax_po - main_tax_po) * 100, "%")` additional tax on all wealth above `r paste0("$",next_increase_po/1e9)` billion
...
# Tax burden on the wealthiest 0.1% 
